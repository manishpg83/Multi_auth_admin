...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="<?php echo e(route('teacher.register')); ?>"><b>Teacher</b>Register</a>
        </div>
        <!-- /.register-logo -->
        <div class="card">
...
<?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-8">
                            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('teacher.login')); ?>">
...
<?php /**PATH /var/www/html/projects/laravel-11-multi-auth/resources/views/teacher/auth/register.blade.php ENDPATH**/ ?>