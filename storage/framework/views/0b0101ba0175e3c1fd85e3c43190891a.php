<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link">User Dashboard</a>
        </li>
    ...
    <ul class="navbar-nav ml-auto">
                ...
                <a href="#" class="dropdown-item">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-sm"> me whenever you can...</p>
                            <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>Hours Ago</p>
                        </div>
                    </div>
                    <!-- Message End -->
                </a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                <i class="far fa-user"></i> <?php echo e(Auth::user()->email); ?>
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sm:hidden">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden">
        <div class="pt-2 pb-3 space-y-1">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link"><?php echo e(__('Dashboard')); ?></a>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="<?php echo e(route('admin.logout')); ?>">
                    <?php echo csrf_field(); ?>
                    <a href="<?php echo e(route('admin.logout')); ?>" class="nav-link" onclick="event.preventDefault(); this.closest('form').submit();"><?php echo e(__('Log Out')); ?></a>
                </form>
            </div>
        </div>
    </div>
</nav>
<?php /**PATH /var/www/html/projects/laravel-11-multi-auth/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>