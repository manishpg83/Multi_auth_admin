        ...
        <div class="pb-1 mt-3 mb-1 user-panel d-flex">
            ...
            <div class="info bg-yellow-400 py-0.5 px-2 ml-2 rounded-lg shadow-md">
                <a href="{{ route('welcome') }}"
                    class="block text-green-700 hover:text-green-800 font-semibold text-md mt-0.5">
                    Lttrsnd
                </a>
            </div>
        </div>
            ...
            <ul class="nav nav-sidebar flex flex-col" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.users.index') }}"
                        ...
                        <i class="fa fa-user {{ request()->routeIs('admin.users.*') ? 'text-yellow-400' : 'text-black' }}"
                            aria-hidden="true"></i>
                        <p
                            class="{{ request()->routeIs('admin.users.*') ? 'text-yellow-400 font-bold' : 'text-black' }} ml-2">
                            Users</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.festivals.index') }}"
                        ...
                        <i class="fa fa-gift {{ request()->routeIs('admin.festivals.*') ? 'text-yellow-400' : 'text-black' }}"
                            aria-hidden="true"></i>
                        <p
                            class="{{ request()->routeIs('admin.festivals.*') ? 'text-yellow-400 font-bold' : 'text-black' }} ml-2">
                            Festivals</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.plans.index') }}"
                        ...
                        <i class="fa fa-calendar {{ request()->routeIs('admin.plans.*') ? 'text-yellow-400' : 'text-black' }}"
                            aria-hidden="true"></i>
                        <p
                            class="{{ request()->routeIs('admin.plans.*') ? 'text-yellow-400 font-bold' : 'text-black' }} ml-2">
                            Plans</p>
                    </a>
                </li>
            </ul>
