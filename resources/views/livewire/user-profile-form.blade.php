    ...
    <form wire:submit.prevent="updateProfile" class="mt-6">
        <div class="mb-3 row">
            <div class="col-md-6">
                ...
                <input id="first_name" name="first_name" type="text" class="form-control" wire:model="first_name"
                    required autofocus>
                @error('first_name')
            ...
            <div class="col-md-6">
                ...
                <input id="last_name" name="last_name" type="text" class="form-control" wire:model="last_name"
                    required autofocus>
                @error('last_name')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
