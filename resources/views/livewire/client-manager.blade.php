                                ...
                                <form class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        <input wire:model.live="search" type="text" id="client-search"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full  p-2 dark:focus:ring-primary-500 dark:focus:border-primary-500"
